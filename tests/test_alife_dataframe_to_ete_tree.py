...
'''
`alife_dataframe_to_ete_tree` tests for
...
def test():
    ...
    converted_tree = apc.alife_dataframe_to_ete_tree(original_df)
    reconverted_df = apc.ete_tree_to_alife_dataframe(converted_tree)
...
def test_empty():
    ...
    assert apc.alife_dataframe_to_ete_tree(df) is None
